...
000000000000011a <grep>:
{
 ...
 142:	a0aa8a93          	addi	s5,s5,-1526 # b48 <buf>
    p = buf;
 146:	8cd6                	mv	s9,s5
 148:	8c56                	mv	s8,s5
  while((n = read(fd, buf+m, sizeof(buf)-m-1)) > 0){
...
00000000000001ea <main>:
{
 ...
 25e:	86658593          	addi	a1,a1,-1946 # ac0 <statistics+0x86>
 262:	4509                	li	a0,2
 ...
 294:	85050513          	addi	a0,a0,-1968 # ae0 <statistics+0xa6>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 608:	4fc50513          	addi	a0,a0,1276 # b00 <digits>
 60c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 814:	2e890913          	addi	s2,s2,744 # af8 <statistics+0xbe>
        while(*s != 0){
...
free(void *ap)
{
 ...
 8dc:	2687b783          	ld	a5,616(a5) # b40 <freep>
 ...
 90a:	00e6ea63          	bltu	a3,a4,91e <free+0x50>
{
 ...
 94c:	1ef73c23          	sd	a5,504(a4) # b40 <freep>
}
 950:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 97e:	1c653503          	ld	a0,454(a0) # b40 <freep>
 ...
 9a6:	19e90913          	addi	s2,s2,414 # b40 <freep>
  if(p == (char*)-1)
 9aa:	5afd                	li	s5,-1
 9ac:	a88d                	j	a1e <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 9ae:	00000797          	auipc	a5,0x0
 9b2:	59a78793          	addi	a5,a5,1434 # f48 <base>
 9b6:	00000717          	auipc	a4,0x0
 9ba:	18f73523          	sd	a5,394(a4) # b40 <freep>
 9be:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 9e0:	16a73223          	sd	a0,356(a4) # b40 <freep>
      return (void*)(p + 1);
...
statistics(void *buf, int sz)
{
 ...
 a54:	0c850513          	addi	a0,a0,200 # b18 <digits+0x18>
 a58:	00000097          	auipc	ra,0x0
 a5c:	b08080e7          	jalr	-1272(ra) # 560 <open>
  if(fd < 0) {
 a60:	04054263          	bltz	a0,aa4 <statistics+0x6a>
 a64:	89aa                	mv	s3,a0
  ...
  for (i = 0; i < sz; ) {
 a66:	4481                	li	s1,0
 a68:	03205063          	blez	s2,a88 <statistics+0x4e>
    if ((n = read(fd, buf+i, sz-i)) < 0) {
 a6c:	4099063b          	subw	a2,s2,s1
 a70:	009a05b3          	add	a1,s4,s1
 a74:	854e                	mv	a0,s3
 a76:	00000097          	auipc	ra,0x0
 a7a:	ac2080e7          	jalr	-1342(ra) # 538 <read>
 a7e:	00054563          	bltz	a0,a88 <statistics+0x4e>
      break;
    }
    i += n;
 a82:	9ca9                	addw	s1,s1,a0
  for (i = 0; i < sz; ) {
 a84:	ff24c4e3          	blt	s1,s2,a6c <statistics+0x32>
  }
  close(fd);
 a88:	854e                	mv	a0,s3
 a8a:	00000097          	auipc	ra,0x0
 a8e:	abe080e7          	jalr	-1346(ra) # 548 <close>
  return i;
}
 a92:	8526                	mv	a0,s1
 ...
 a9a:	6942                	ld	s2,16(sp)
 a9c:	69a2                	ld	s3,8(sp)
 a9e:	6a02                	ld	s4,0(sp)
 aa0:	6145                	addi	sp,sp,48
 aa2:	8082                	ret
      fprintf(2, "stats: open failed\n");
 aa4:	00000597          	auipc	a1,0x0
 aa8:	08458593          	addi	a1,a1,132 # b28 <digits+0x28>
 aac:	4509                	li	a0,2
 aae:	00000097          	auipc	ra,0x0
 ab2:	dbc080e7          	jalr	-580(ra) # 86a <fprintf>
      exit(1);
 ab6:	4505                	li	a0,1
 ab8:	00000097          	auipc	ra,0x0
 abc:	a68080e7          	jalr	-1432(ra) # 520 <exit>
